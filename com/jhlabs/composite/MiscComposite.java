...
public final class MiscComposite implements Composite {
  ...
  public static String[] RULE_NAMES = new String[] { 
      "Normal", "Add", "Subtract", "Difference", "Multiply", "Darken", "Burn", "Color Burn", "Screen", "Lighten", 
      "Dodge", "Color Dodge", "Hue", "Saturation", "Brightness", "Color", "Overlay", "Soft Light", "Hard Light", "Pin Light", 
      "Exclusion", "Negation", "Average", "Stencil", "Silhouette" };
  ...
  public static Composite getInstance(int rule, float alpha) {
    switch (rule) {
      ...
      case 7:
        return (Composite)new ColorBurnComposite(alpha);
      case 8:
      ...
      case 20:
        return (Composite)new ExclusionComposite(alpha);
      case 21:
