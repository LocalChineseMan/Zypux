...
public class GaussianFilter extends ConvolveFilter {
  ...
  public BufferedImage filter(BufferedImage src, BufferedImage dst) {
    ...
    if (this.radius > 0.0F) {
      convolveAndTranspose(this.kernel, inPixels, outPixels, width, height, this.alpha, ConvolveFilter.CLAMP_EDGES);
      convolveAndTranspose(this.kernel, outPixels, inPixels, height, width, this.alpha, ConvolveFilter.CLAMP_EDGES);
    } 
