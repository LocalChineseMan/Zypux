...
public class WarpFilter extends WholeImageFilter {
  ...
  protected int[] filterPixels(int width, int height, int[] inPixels, Rectangle transformedSpace) {
    ...
    if (this.morphImage != null) {
      int[] morphPixels = getRGB(this.morphImage, 0, 0, width, height, null);
      morph(inPixels, morphPixels, outPixels, this.sourceGrid, this.destGrid, width, height, this.time);
