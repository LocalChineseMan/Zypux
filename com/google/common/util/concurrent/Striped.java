...
public abstract class Striped<L> {
  ...
  public static Striped<Lock> lock(int stripes) {
    return (Striped<Lock>)new CompactStriped(stripes, new Supplier<Lock>() {
          public Lock get() {
  ...
  private static <L> Striped<L> lazy(int stripes, Supplier<L> supplier) {
    return (stripes < 1024) ? (Striped<L>)new SmallLazyStriped<L>(stripes, supplier) : (Striped<L>)new LargeLazyStriped<L>(stripes, supplier);
  }
  
  public static Striped<Semaphore> semaphore(int stripes, final int permits) {
    return (Striped<Semaphore>)new CompactStriped(stripes, new Supplier<Semaphore>() {
  ...
  public static Striped<ReadWriteLock> readWriteLock(int stripes) {
    return (Striped<ReadWriteLock>)new CompactStriped(stripes, READ_WRITE_LOCK_SUPPLIER);
  }
  ...
  private static abstract class Striped {}
