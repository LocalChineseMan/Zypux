...
public final class Tables {
  ...
  public static <R, C, V> Table<C, R, V> transpose(Table<R, C, V> table) {
    return (table instanceof TransposeTable) ? ((TransposeTable)table).original : (Table<C, R, V>)new TransposeTable<C, R, V>(table);
  }
  ...
  public static <R, C, V> Table<R, C, V> newCustomTable(Map<R, Map<C, V>> backingMap, Supplier<? extends Map<C, V>> factory) {
    ...
    return (Table<R, C, V>)new StandardTable(backingMap, factory);
  }
  
  @Beta
  public static <R, C, V1, V2> Table<R, C, V2> transformValues(Table<R, C, V1> fromTable, Function<? super V1, V2> function) {
    return (Table)new TransformedTable<R, C, V1, V2>(fromTable, function);
  }
