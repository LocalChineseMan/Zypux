...
public final class EnumBiMap<K extends Enum<K>, V extends Enum<V>> extends AbstractBiMap<K, V> {
  ...
  private EnumBiMap(Class<K> keyType, Class<V> valueType) {
    super((Map)WellBehavedMap.wrap(new EnumMap<Object, Object>(keyType)), (Map)WellBehavedMap.wrap(new EnumMap<Object, Object>(valueType)));
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    setDelegates((Map)WellBehavedMap.wrap(new EnumMap<Object, Object>(this.keyType)), (Map)WellBehavedMap.wrap(new EnumMap<Object, Object>(this.valueType)));
