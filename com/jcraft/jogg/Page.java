...
public class Page {
  ...
  public long granulepos() {
    ...
    foo = foo << 8L | (this.header_base[this.header + 12] & 0xFF);
    foo = foo << 8L | (this.header_base[this.header + 11] & 0xFF);
    foo = foo << 8L | (this.header_base[this.header + 10] & 0xFF);
    foo = foo << 8L | (this.header_base[this.header + 9] & 0xFF);
    foo = foo << 8L | (this.header_base[this.header + 8] & 0xFF);
    foo = foo << 8L | (this.header_base[this.header + 7] & 0xFF);
    foo = foo << 8L | (this.header_base[this.header + 6] & 0xFF);
    return foo;
  }
