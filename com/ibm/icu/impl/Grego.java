...
public class Grego {
  ...
  private static final int[] MONTH_LENGTH = new int[] { 
      ...
      30, 31, 31, 29, 31, 30, 31, 30, 31, 31, 
      30, 31, 30, 31 };
  
  private static final int[] DAYS_BEFORE = new int[] { 
      0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 
      304, 334, 0, 31, 60, 91, 121, 152, 182, 213, 
      244, 274, 305, 335 };
  ...
  public static long fieldsToDay(int year, int month, int dom) {
    int y = year - 1;
    long julian = (365 * y) + floorDivide(y, 4L) + 1721423L + floorDivide(y, 400L) - floorDivide(y, 100L) + 2L + DAYS_BEFORE[month + (isLeapYear(year) ? 12 : 0)] + dom;
