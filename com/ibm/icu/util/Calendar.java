...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
  ...
  protected DateFormat handleGetDateFormat(String pattern, String override, ULocale locale) {
    ...
    FormatConfiguration.access$102(fmtConfig, pattern);
    FormatConfiguration.access$202(fmtConfig, override);
    FormatConfiguration.access$302(fmtConfig, new DateFormatSymbols(this, locale));
    FormatConfiguration.access$402(fmtConfig, locale);
    FormatConfiguration.access$502(fmtConfig, this);
