  ...
  public boolean next(ValueIterator.Element element) {
    ...
    if (this.m_choice_ == 0 || this.m_choice_ == 2) {
      ...
      if (this.m_algorithmIndex_ < length) {
        while (this.m_algorithmIndex_ < length) {
          if (this.m_algorithmIndex_ < 0 || this.m_name_.getAlgorithmEnd(this.m_algorithmIndex_) < this.m_current_)
    ...
    if (this.m_choice_ == 2 && 
      !iterateExtended(element, this.m_limit_)) {
      this.m_current_++;
      return true;
    } 
    return false;
