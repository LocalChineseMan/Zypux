...
public class QueryBuilder {
  ...
  public String toQueryString() {
    ...
    stringBuilder.append(firstKey).append("=").append(encodeString(this.queryParams.get(firstKey)));
    while (keyIterator.hasNext()) {
      String key = keyIterator.next();
      stringBuilder.append("&").append(key).append("=").append(encodeString(this.queryParams.get(key)));
    } 
