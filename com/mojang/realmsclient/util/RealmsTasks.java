    ...
    public void run() {
      ...
      try {
        ...
        if (server != null) {
          ...
          RealmsResetWorldScreen resetWorldScreen = new RealmsResetWorldScreen((RealmsScreen)this.lastScreen, server, this.lastScreen.newScreen(), RealmsScreen.getLocalizedString("mco.selectServer.create"), RealmsScreen.getLocalizedString("mco.create.world.subtitle"), 10526880, RealmsScreen.getLocalizedString("mco.create.world.skip"));
