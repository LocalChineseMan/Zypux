...
public class RealmsResetWorldScreen extends RealmsScreenWithCallback<WorldTemplate> {
  ...
  public void mouseClicked(int x, int y, int buttonNum) {
    ...
    switch (this.selectedType) {
      ...
      case ADVENTURE:
        screen = new RealmsSelectWorldTemplateScreen(this, null, false, this.adventuremaps);
      ...
      case SURVIVAL_SPAWN:
        templateScreen = new RealmsSelectWorldTemplateScreen(this, null, false, this.templates);
