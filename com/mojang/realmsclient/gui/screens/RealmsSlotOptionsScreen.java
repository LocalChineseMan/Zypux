...
public class RealmsSlotOptionsScreen extends RealmsScreen {
  ...
  public void init() {
    ...
    buttonsAdd(this.pvpButton = newButton(4, this.column2_x, RealmsConstants.row(2), this.column_width, 20, pvpTitle()));
    buttonsAdd(newButton(3, this.column1_x, RealmsConstants.row(4), this.column_width, 20, gameModeTitle()));
  ...
  private void saveSettings() {
    if (this.worldType.equals(RealmsServer.WorldType.ADVENTUREMAP)) {
      ...
      this.parent.saveSlotSettings(new RealmsWorldOptions(this.pvp, this.spawnAnimals, this.spawnMonsters, this.spawnNPCs, this.spawnProtection, this.commandBlocks, Integer.valueOf(this.difficultyIndex), Integer.valueOf(this.gameModeIndex), this.forceGameMode, getSlotName()));
    } 
  }
}
