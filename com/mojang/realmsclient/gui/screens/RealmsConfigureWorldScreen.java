...
public class RealmsConfigureWorldScreen extends RealmsScreenWithCallback<WorldTemplate> {
  ...
  public void render(int xm, int ym, float a) {
    ...
    drawCenteredString(name, width() / 2, 24, nameColor);
    int statusX = Math.min(centerButton(2, 3) + this.default_button_width - 11, width() / 2 + nameWidth / 2 + titleWidth / 2 + 10);
    drawServerStatus(statusX, 7, xm, ym);
    for (Map.Entry<Integer, RealmsWorldOptions> entry : (Iterable<Map.Entry<Integer, RealmsWorldOptions>>)this.serverData.slots.entrySet()) {
      if (((RealmsWorldOptions)entry.getValue()).templateImage != null && ((RealmsWorldOptions)entry.getValue()).templateId != -1L) {
        drawSlotFrame(frame(((Integer)entry.getKey()).intValue()), RealmsConstants.row(5) + 5, xm, ym, (this.serverData.activeSlot == ((Integer)entry.getKey()).intValue() && !isMinigame()), ((RealmsWorldOptions)entry.getValue()).getSlotName(((Integer)entry.getKey()).intValue()), ((Integer)entry.getKey()).intValue(), ((RealmsWorldOptions)entry.getValue()).templateId, ((RealmsWorldOptions)entry.getValue()).templateImage, ((RealmsWorldOptions)entry.getValue()).empty);
        continue;
      } 
      drawSlotFrame(frame(((Integer)entry.getKey()).intValue()), RealmsConstants.row(5) + 5, xm, ym, (this.serverData.activeSlot == ((Integer)entry.getKey()).intValue() && !isMinigame()), ((RealmsWorldOptions)entry.getValue()).getSlotName(((Integer)entry.getKey()).intValue()), ((Integer)entry.getKey()).intValue(), -1L, (String)null, ((RealmsWorldOptions)entry.getValue()).empty);
    } 
  ...
  public void buttonClicked(RealmsButton button) {
    ...
    switch (button.id()) {
      ...
      case 6:
        ...
        return;
      case 5:
        Realms.setScreen(new RealmsSlotOptionsScreen(this, ((RealmsWorldOptions)this.serverData.slots.get(Integer.valueOf(this.serverData.activeSlot))).clone(), this.serverData.worldType, this.serverData.activeSlot));
        return;
      case 7:
  ...
  public void mouseClicked(int x, int y, int buttonNum) {
    ...
    if (this.hoveredSlot != -1) {
      if (this.hoveredSlot < 4) {
        ...
        if (((RealmsWorldOptions)this.serverData.slots.get(Integer.valueOf(this.hoveredSlot))).empty) {
  ...
  public void saveSlotSettings() {
    RealmsClient client = RealmsClient.createRealmsClient();
    try {
      client.updateSlot(this.serverData.id, this.serverData.activeSlot, (RealmsWorldOptions)this.serverData.slots.get(Integer.valueOf(this.serverData.activeSlot)));
    } catch (RealmsServiceException e) {
  ...
  public void saveSlotSettings(RealmsWorldOptions options) {
    RealmsWorldOptions oldOptions = (RealmsWorldOptions)this.serverData.slots.get(Integer.valueOf(this.serverData.activeSlot));
