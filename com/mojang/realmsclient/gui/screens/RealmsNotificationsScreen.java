...
public class RealmsNotificationsScreen extends RealmsScreen {
  ...
  private static final List<RealmsDataFetcher.Task> tasks = Arrays.asList(new RealmsDataFetcher.Task[] { RealmsDataFetcher.Task.PENDING_INVITE, RealmsDataFetcher.Task.TRIAL_AVAILABLE });
  ...
  private void drawIcons(int xm, int ym) {
    ...
    int spacing = 24;
    int topPos = height() / 4 + 48;
    int baseX = width() / 2 + 80;
