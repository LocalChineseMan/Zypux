...
final class PooledHeapByteBuf extends PooledByteBuf<byte[]> {
  private static final Recycler<PooledHeapByteBuf> RECYCLER = (Recycler<PooledHeapByteBuf>)new Object();
  ...
  protected long _getLong(int index) {
    index = idx(index);
    return (((byte[])this.memory)[index] & 0xFFL) << 56L | (((byte[])this.memory)[index + 1] & 0xFFL) << 48L | (((byte[])this.memory)[index + 2] & 0xFFL) << 40L | (((byte[])this.memory)[index + 3] & 0xFFL) << 32L | (((byte[])this.memory)[index + 4] & 0xFFL) << 24L | (((byte[])this.memory)[index + 5] & 0xFFL) << 16L | (((byte[])this.memory)[index + 6] & 0xFFL) << 8L | ((byte[])this.memory)[index + 7] & 0xFFL;
  }
  ...
  protected void _setLong(int index, long value) {
    index = idx(index);
    ((byte[])this.memory)[index] = (byte)(int)(value >>> 56L);
    ((byte[])this.memory)[index + 1] = (byte)(int)(value >>> 48L);
    ((byte[])this.memory)[index + 2] = (byte)(int)(value >>> 40L);
    ((byte[])this.memory)[index + 3] = (byte)(int)(value >>> 32L);
    ((byte[])this.memory)[index + 4] = (byte)(int)(value >>> 24L);
    ((byte[])this.memory)[index + 5] = (byte)(int)(value >>> 16L);
    ((byte[])this.memory)[index + 6] = (byte)(int)(value >>> 8L);
