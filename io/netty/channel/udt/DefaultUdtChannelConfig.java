...
public class DefaultUdtChannelConfig extends DefaultChannelConfig implements UdtChannelConfig {
  ...
  public Map<ChannelOption<?>, Object> getOptions() {
    return getOptions(super.getOptions(), new ChannelOption[] { (ChannelOption)UdtChannelOption.PROTOCOL_RECEIVE_BUFFER_SIZE, (ChannelOption)UdtChannelOption.PROTOCOL_SEND_BUFFER_SIZE, (ChannelOption)UdtChannelOption.SYSTEM_RECEIVE_BUFFER_SIZE, (ChannelOption)UdtChannelOption.SYSTEM_SEND_BUFFER_SIZE, UdtChannelOption.SO_RCVBUF, UdtChannelOption.SO_SNDBUF, UdtChannelOption.SO_REUSEADDR, UdtChannelOption.SO_LINGER });
  }
