...
public abstract class HttpObjectDecoder extends ReplayingDecoder<HttpObjectDecoder.State> {
  ...
  private final HeaderParser headerParser = new HeaderParser(this, this.seq);
  
  private final LineParser lineParser = new LineParser(this, this.seq);
  ...
  protected void decode(ChannelHandlerContext ctx, ByteBuf buffer, List<Object> out) throws Exception {
    ...
    HttpContent chunk;
    ByteBuf content;
    switch (null.$SwitchMap$io$netty$handler$codec$http$HttpObjectDecoder$State[((State)state()).ordinal()]) {
      case 1:
        try {
