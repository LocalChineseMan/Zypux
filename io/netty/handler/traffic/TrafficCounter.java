...
public class TrafficCounter {
  ...
  public synchronized void start() {
    ...
    if (this.checkInterval.get() > 0L) {
      ...
      this.monitor = (Runnable)new TrafficMonitoringTask(this.trafficShapingHandler, this);
  ...
  public String toString() {
    return "Monitor " + this.name + " Current Speed Read: " + (this.lastReadThroughput >> 10L) + " KB/s, Write: " + (this.lastWriteThroughput >> 10L) + " KB/s Current Read: " + (this.currentReadBytes.get() >> 10L) + " KB Current Write: " + (this.currentWrittenBytes.get() >> 10L) + " KB";
  }
