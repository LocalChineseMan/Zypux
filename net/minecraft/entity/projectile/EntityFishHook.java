...
public class EntityFishHook extends Entity {
  ...
  public EntityFishHook(World worldIn, EntityPlayer fishingPlayer) {
    ...
    setSize(0.25F, 0.25F);
    setLocationAndAngles(fishingPlayer.posX, fishingPlayer.posY + fishingPlayer.getEyeHeight(), fishingPlayer.posZ, fishingPlayer.rotationYaw, fishingPlayer.rotationPitch);
  ...
  public void onUpdate() {
    ...
    if (this.fishPosRotationIncrements > 0) {
      ...
      if (!this.worldObj.isRemote) {
        ...
        if (this.angler.isDead || !this.angler.isEntityAlive() || itemstack == null || itemstack.getItem() != Items.fishing_rod || getDistanceSqToEntity((Entity)this.angler) > 1024.0D) {
          setDead();
      ...
      if (movingobjectposition != null)
        if (movingobjectposition.entityHit != null) {
          if (movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, (Entity)this.angler), 0.0F))
        ...
        if (!this.worldObj.isRemote && d10 > 0.0D) {
          ...
          if (this.ticksCatchable > 0) {
            ...
            if (this.ticksCatchableDelay <= 0) {
              ...
              float f8 = MathHelper.floor_double((getEntityBoundingBox()).minY);
              ...
              double d15 = (MathHelper.floor_double((getEntityBoundingBox()).minY) + 1.0F);
            ...
            if (this.rand.nextFloat() < f1) {
              ...
              double d14 = (MathHelper.floor_double((getEntityBoundingBox()).minY) + 1.0F);
  ...
  public int handleHookRetraction() {
    ...
    if (this.caughtEntity != null) {
      ...
      EntityItem entityitem = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, getFishingResult());
      ...
      this.angler.worldObj.spawnEntityInWorld((Entity)new EntityXPOrb(this.angler.worldObj, this.angler.posX, this.angler.posY + 0.5D, this.angler.posZ + 0.5D, this.rand.nextInt(6) + 1));
      i = 1;
    } 
    if (this.inGround)
      i = 2; 
