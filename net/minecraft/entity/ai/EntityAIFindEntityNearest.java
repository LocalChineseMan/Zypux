...
public class EntityAIFindEntityNearest extends EntityAIBase {
  ...
  public EntityAIFindEntityNearest(EntityLiving mobIn, Class<? extends EntityLivingBase> p_i45884_2_) {
    ...
    this.field_179443_c = new Predicate<EntityLivingBase>() {
        public boolean apply(EntityLivingBase p_apply_1_) {
          ...
          return p_apply_1_.isInvisible() ? false : ((p_apply_1_.getDistanceToEntity((Entity)EntityAIFindEntityNearest.this.mob) > d0) ? false : EntityAITarget.isSuitableTarget(EntityAIFindEntityNearest.this.mob, p_apply_1_, false, true));
        }
      };
  ...
  public boolean shouldExecute() {
    ...
    Collections.sort(list, (Comparator<? super EntityLivingBase>)this.field_179440_d);
    if (list.isEmpty())
      return false; 
