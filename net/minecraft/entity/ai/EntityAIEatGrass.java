...
public class EntityAIEatGrass extends EntityAIBase {
  private static final Predicate<IBlockState> field_179505_b = (Predicate<IBlockState>)BlockStateHelper.forBlock((Block)Blocks.tallgrass).where((IProperty)BlockTallGrass.TYPE, Predicates.equalTo(BlockTallGrass.EnumType.GRASS));
