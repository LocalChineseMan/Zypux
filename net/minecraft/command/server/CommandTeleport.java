  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException {
    ...
    if (args.length != 1 && args.length != 2) {
      ...
      if (entity.worldObj != null) {
        ...
        notifyOperators(sender, (ICommand)this, "commands.tp.success.coordinates", new Object[] { entity.getName(), Double.valueOf(commandbase$coordinatearg.func_179628_a()), Double.valueOf(commandbase$coordinatearg1.func_179628_a()), Double.valueOf(commandbase$coordinatearg2.func_179628_a()) });
      } 
    } else {
      ...
      notifyOperators(sender, (ICommand)this, "commands.tp.success", new Object[] { entity.getName(), entity1.getName() });
    } 
  }
