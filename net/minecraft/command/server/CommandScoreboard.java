...
public class CommandScoreboard extends CommandBase {
    ...
    if (!func_175780_b(sender, args)) {
      ...
      if (args[0].equalsIgnoreCase("objectives")) {
        ...
        if (args[1].equalsIgnoreCase("list")) {
          ...
          if (args.length < 4 && (args.length != 3 || !(sender instanceof net.minecraft.entity.player.EntityPlayer)))
            throw new WrongUsageException("commands.scoreboard.teams.join.usage", new Object[0]); 
          joinTeam(sender, args, 2);
        } else if (args[1].equalsIgnoreCase("leave")) {
          if (args.length < 3 && !(sender instanceof net.minecraft.entity.player.EntityPlayer))
  ...
  private boolean func_175780_b(ICommandSender p_175780_1_, String[] p_175780_2_) throws CommandException {
    ...
    for (int j = 0; j < p_175780_2_.length; j++) {
      if (isUsernameIndex(p_175780_2_, j) && "*".equals(p_175780_2_[j])) {
        if (i >= 0)
    ...
    if (i < 0)
      return false; 
    List<String> list1 = Lists.newArrayList(getScoreboard().getObjectiveNames());
  ...
  protected void addObjective(ICommandSender sender, String[] args, int index) throws CommandException {
    ...
    notifyOperators(sender, (ICommand)this, "commands.scoreboard.objectives.add.success", new Object[] { s });
  }
  ...
  protected void addTeam(ICommandSender sender, String[] args, int index) throws CommandException {
    ...
    notifyOperators(sender, (ICommand)this, "commands.scoreboard.teams.add.success", new Object[] { s });
  }
  
  protected void setTeamOption(ICommandSender sender, String[] args, int index) throws CommandException {
    ScorePlayerTeam scoreplayerteam = getTeam(args[index++]);
    if (scoreplayerteam != null) {
      ...
      notifyOperators(sender, (ICommand)this, "commands.scoreboard.teams.option.success", new Object[] { s, scoreplayerteam.getRegisteredName(), s1 });
    } 
  }
  
  protected void removeTeam(ICommandSender p_147194_1_, String[] p_147194_2_, int p_147194_3_) throws CommandException {
    Scoreboard scoreboard = getScoreboard();
    ScorePlayerTeam scoreplayerteam = getTeam(p_147194_2_[p_147194_3_]);
    if (scoreplayerteam != null) {
      scoreboard.removeTeam(scoreplayerteam);
      notifyOperators(p_147194_1_, (ICommand)this, "commands.scoreboard.teams.remove.success", new Object[] { scoreplayerteam.getRegisteredName() });
    } 
  }
  ...
  protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException {
    ...
    if (p_147186_2_.length > p_147186_3_) {
      ScorePlayerTeam scoreplayerteam = getTeam(p_147186_2_[p_147186_3_]);
      if (scoreplayerteam == null)
        return; 
      ...
      p_147186_1_.addChatMessage((IChatComponent)new ChatComponentText(joinNiceString(collection.toArray())));
    } else {
      ...
      for (ScorePlayerTeam scoreplayerteam1 : collection1) {
        p_147186_1_.addChatMessage((IChatComponent)new ChatComponentTranslation("commands.scoreboard.teams.list.entry", new Object[] { scoreplayerteam1.getRegisteredName(), scoreplayerteam1.getTeamName(), Integer.valueOf(scoreplayerteam1.getMembershipCollection().size()) }));
      } 
    } 
  }
  ...
  protected void joinTeam(ICommandSender p_147190_1_, String[] p_147190_2_, int p_147190_3_) throws CommandException {
    ...
    if (p_147190_1_ instanceof net.minecraft.entity.player.EntityPlayer && p_147190_3_ == p_147190_2_.length) {
    ...
    if (!set.isEmpty()) {
      ...
      notifyOperators(p_147190_1_, (ICommand)this, "commands.scoreboard.teams.join.success", new Object[] { Integer.valueOf(set.size()), s, joinNiceString(set.toArray((Object[])new String[set.size()])) });
    } 
    if (!set1.isEmpty())
  ...
  protected void leaveTeam(ICommandSender p_147199_1_, String[] p_147199_2_, int p_147199_3_) throws CommandException {
    ...
    Set<String> set = Sets.newHashSet();
    Set<String> set1 = Sets.newHashSet();
    if (p_147199_1_ instanceof net.minecraft.entity.player.EntityPlayer && p_147199_3_ == p_147199_2_.length) {
    ...
    if (!set.isEmpty()) {
      ...
      notifyOperators(p_147199_1_, (ICommand)this, "commands.scoreboard.teams.leave.success", new Object[] { Integer.valueOf(set.size()), joinNiceString(set.toArray((Object[])new String[set.size()])) });
    } 
    if (!set1.isEmpty())
  ...
  protected void emptyTeam(ICommandSender p_147188_1_, String[] p_147188_2_, int p_147188_3_) throws CommandException {
    Scoreboard scoreboard = getScoreboard();
    ScorePlayerTeam scoreplayerteam = getTeam(p_147188_2_[p_147188_3_]);
    if (scoreplayerteam != null) {
      ...
      notifyOperators(p_147188_1_, (ICommand)this, "commands.scoreboard.teams.empty.success", new Object[] { Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName() });
    } 
  }
  
  protected void removeObjective(ICommandSender p_147191_1_, String p_147191_2_) throws CommandException {
    Scoreboard scoreboard = getScoreboard();
    ScoreObjective scoreobjective = getObjective(p_147191_2_, false);
    scoreboard.removeObjective(scoreobjective);
    notifyOperators(p_147191_1_, (ICommand)this, "commands.scoreboard.objectives.remove.success", new Object[] { p_147191_2_ });
  }
  ...
  protected void setObjectiveDisplay(ICommandSender p_147198_1_, String[] p_147198_2_, int p_147198_3_) throws CommandException {
    ...
    if (p_147198_2_.length == 4)
      scoreobjective = getObjective(p_147198_2_[p_147198_3_], false); 
    if (i < 0)
    ...
    if (scoreobjective != null) {
      notifyOperators(p_147198_1_, (ICommand)this, "commands.scoreboard.objectives.setdisplay.successSet", new Object[] { Scoreboard.getObjectiveDisplaySlot(i), scoreobjective.getName() });
    } else {
      notifyOperators(p_147198_1_, (ICommand)this, "commands.scoreboard.objectives.setdisplay.successCleared", new Object[] { Scoreboard.getObjectiveDisplaySlot(i) });
    } 
  }
  ...
  protected void listPlayers(ICommandSender p_147195_1_, String[] p_147195_2_, int p_147195_3_) throws CommandException {
    ...
    if (p_147195_2_.length > p_147195_3_) {
      ...
      for (Score score : map.values()) {
        p_147195_1_.addChatMessage((IChatComponent)new ChatComponentTranslation("commands.scoreboard.players.list.player.entry", new Object[] { Integer.valueOf(score.getScorePoints()), score.getObjective().getDisplayName(), score.getObjective().getName() }));
      } 
    } else {
      ...
      p_147195_1_.addChatMessage((IChatComponent)new ChatComponentText(joinNiceString(collection.toArray())));
    } 
  }
  ...
  protected void setPlayer(ICommandSender p_147197_1_, String[] p_147197_2_, int p_147197_3_) throws CommandException {
    ...
    ScoreObjective scoreobjective = getObjective(p_147197_2_[p_147197_3_++], true);
    ...
    notifyOperators(p_147197_1_, (ICommand)this, "commands.scoreboard.players.set.success", new Object[] { scoreobjective.getName(), s1, Integer.valueOf(score.getScorePoints()) });
  }
  ...
  protected void resetPlayers(ICommandSender p_147187_1_, String[] p_147187_2_, int p_147187_3_) throws CommandException {
    ...
    if (p_147187_2_.length > p_147187_3_) {
      ScoreObjective scoreobjective = getObjective(p_147187_2_[p_147187_3_++], false);
      scoreboard.removeObjectiveFromEntity(s, scoreobjective);
      notifyOperators(p_147187_1_, (ICommand)this, "commands.scoreboard.players.resetscore.success", new Object[] { scoreobjective.getName(), s });
    } else {
      scoreboard.removeObjectiveFromEntity(s, (ScoreObjective)null);
      notifyOperators(p_147187_1_, (ICommand)this, "commands.scoreboard.players.reset.success", new Object[] { s });
    } 
  }
  ...
  protected void func_175779_n(ICommandSender p_175779_1_, String[] p_175779_2_, int p_175779_3_) throws CommandException {
    ...
    ScoreObjective scoreobjective = getObjective(p_175779_2_[p_175779_3_], false);
    ...
    notifyOperators(p_175779_1_, (ICommand)this, "commands.scoreboard.players.enable.success", new Object[] { scoreobjective.getName(), s });
  }
  ...
  protected void func_175781_o(ICommandSender p_175781_1_, String[] p_175781_2_, int p_175781_3_) throws CommandException {
    ...
    if (s.length() > 40)
      throw new SyntaxErrorException("commands.scoreboard.players.name.tooLong", new Object[] { s, Integer.valueOf(40) }); 
    ScoreObjective scoreobjective = getObjective(p_175781_2_[p_175781_3_++], false);
    ...
    if (score.getScorePoints() >= i && score.getScorePoints() <= j) {
      notifyOperators(p_175781_1_, (ICommand)this, "commands.scoreboard.players.test.success", new Object[] { Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j) });
    } else {
  ...
  protected void func_175778_p(ICommandSender p_175778_1_, String[] p_175778_2_, int p_175778_3_) throws CommandException {
    ...
    ScoreObjective scoreobjective = getObjective(p_175778_2_[p_175778_3_++], true);
    String s1 = p_175778_2_[p_175778_3_++];
    String s2 = getEntityName(p_175778_1_, p_175778_2_[p_175778_3_++]);
    ScoreObjective scoreobjective1 = getObjective(p_175778_2_[p_175778_3_], false);
    if (s.length() > 40)
      throw new SyntaxErrorException("commands.scoreboard.players.name.tooLong", new Object[] { s, Integer.valueOf(40) }); 
    if (s2.length() > 40)
    ...
    notifyOperators(p_175778_1_, (ICommand)this, "commands.scoreboard.players.operation.success", new Object[0]);
  }
  ...
  public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
    ...
    if (args[0].equalsIgnoreCase("objectives")) {
      ...
      if (args[1].equalsIgnoreCase("add")) {
        ...
        if (args.length == 3)
          return getListOfStringsMatchingLastWord(args, func_147184_a(false)); 
      ...
      if (!args[1].equalsIgnoreCase("set") && !args[1].equalsIgnoreCase("add") && !args[1].equalsIgnoreCase("remove") && !args[1].equalsIgnoreCase("reset")) {
        if (args[1].equalsIgnoreCase("enable")) {
          ...
          if (args.length == 4)
            return getListOfStringsMatchingLastWord(args, func_175782_e()); 
          ...
          if (args[1].equalsIgnoreCase("operation")) {
            ...
            if (args.length == 4)
              return getListOfStringsMatchingLastWord(args, func_147184_a(true)); 
            if (args.length == 5)
      ...
      if (args[1].equalsIgnoreCase("join")) {
        if (args.length == 3)
          return getListOfStringsMatchingLastWord(args, getScoreboard().getTeamNames()); 
        if (args.length >= 4)
          return getListOfStringsMatchingLastWord(args, MinecraftServer.getServer().getAllUsernames()); 
      } else {
  ...
  protected List<String> func_147184_a(boolean p_147184_1_) {
    Collection<ScoreObjective> collection = getScoreboard().getScoreObjectives();
    List<String> list = Lists.newArrayList();
    for (ScoreObjective scoreobjective : collection) {
