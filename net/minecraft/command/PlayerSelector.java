...
public class PlayerSelector {
  ...
  private static List<World> getWorlds(ICommandSender sender, Map<String, String> argumentMap) {
    ...
    if (func_179665_h(argumentMap)) {
      ...
      Collections.addAll(list, (Object[])(MinecraftServer.getServer()).worldServers);
    } 
    return list;
  }
      ...
      if (flag1)
        list.add(new Predicate<Entity>() {
              public boolean apply(Entity p_apply_1_) {
                return p_apply_1_ instanceof net.minecraft.entity.player.EntityPlayer;
              }
            }); 
    } else {
      final String s_f = s;
  ...
  private static List<Predicate<Entity>> getScorePredicates(Map<String, String> p_179657_0_) {
    List<Predicate<Entity>> list = Lists.newArrayList();
    Map<String, Integer> map = func_96560_a(p_179657_0_);
    if (map.size() > 0)
      list.add(p_apply_1_ -> {
  ...
  private static List<Predicate<Entity>> getRotationsPredicates(Map<String, String> p_179662_0_) {
    ...
    if (p_179662_0_.containsKey("rym") || p_179662_0_.containsKey("ry")) {
      ...
      list.add(p_apply_1_ -> {
            int i1 = func_179650_a((int)Math.floor(p_apply_1_.rotationYaw));
    ...
    if (p_179662_0_.containsKey("rxm") || p_179662_0_.containsKey("rx")) {
      ...
      list.add(p_apply_1_ -> {
            int i1 = func_179650_a((int)Math.floor(p_apply_1_.rotationPitch));
  ...
  private static <T extends Entity> List<T> func_179658_a(List<T> p_179658_0_, Map<String, String> p_179658_1_, ICommandSender p_179658_2_, Class<? extends T> p_179658_3_, String p_179658_4_, BlockPos p_179658_5_) {
    ...
    if (!p_179658_4_.equals("p") && !p_179658_4_.equals("a") && !p_179658_4_.equals("e")) {
      ...
      Collections.sort(p_179658_0_, (p_compare_1_, p_compare_2_) -> ComparisonChain.start().compare(p_compare_1_.getDistanceSq(p_179658_5_), p_compare_2_.getDistanceSq(p_179658_5_)).result());
    } 
