...
public abstract class CommandBase implements ICommand {
  ...
  public static int parseInt(String input, int min) throws NumberInvalidException {
    return parseInt(input, min, 2147483647);
  }
  ...
  public static <T extends Entity> T getEntity(ICommandSender commandSender, String p_175759_1_, Class<? extends T> p_175759_2_) throws EntityNotFoundException {
    ...
    if (entity == null)
      entityPlayerMP = minecraftserver.getConfigurationManager().getPlayerByUsername(p_175759_1_); 
    if (entityPlayerMP == null)
      try {
        UUID uuid = UUID.fromString(p_175759_1_);
        Entity entity1 = minecraftserver.getEntityFromUuid(uuid);
        if (entity1 == null)
          entityPlayerMP = minecraftserver.getConfigurationManager().getPlayerByUUID(uuid); 
      } catch (IllegalArgumentException var6) {
        throw new EntityNotFoundException("commands.generic.entity.invalidUuid", new Object[0]);
      }  
    if (entityPlayerMP != null && p_175759_2_.isAssignableFrom(entityPlayerMP.getClass()))
      return (T)entityPlayerMP; 
  ...
  public static List<Entity> func_175763_c(ICommandSender p_175763_0_, String p_175763_1_) throws EntityNotFoundException {
    return PlayerSelector.hasArguments(p_175763_1_) ? PlayerSelector.<Entity>matchEntities(p_175763_0_, p_175763_1_, Entity.class) : Lists.newArrayList((Object[])new Entity[] { getEntity(p_175763_0_, p_175763_1_) });
  }
  ...
  public static IChatComponent getChatComponentFromNthArg(ICommandSender sender, String[] args, int index, boolean p_147176_3_) throws PlayerNotFoundException {
    ...
    for (int i = index; i < args.length; i++) {
      ...
      ChatComponentText chatComponentText1 = new ChatComponentText(args[i]);
      if (p_147176_3_) {
  ...
  public static String joinNiceStringFromCollection(Collection<String> strings) {
    return joinNiceString(strings.toArray((Object[])new String[strings.size()]));
  }
  ...
  public static List<String> getListOfStringsMatchingLastWord(String[] args, String... possibilities) {
    return getListOfStringsMatchingLastWord(args, Arrays.asList((Object[])possibilities));
  }
