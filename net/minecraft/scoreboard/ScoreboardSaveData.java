...
public class ScoreboardSaveData extends WorldSavedData {
  ...
  public void setScoreboard(Scoreboard scoreboardIn) {
    ...
    if (this.delayedInitNbt != null)
      readFromNBT(this.delayedInitNbt); 
  }
  ...
  public void writeToNBT(NBTTagCompound nbt) {
    if (this.theScoreboard == null) {
      ...
      nbt.setTag("Objectives", (NBTBase)objectivesToNbt());
      nbt.setTag("PlayerScores", (NBTBase)scoresToNbt());
      nbt.setTag("Teams", (NBTBase)func_96496_a());
      func_96497_d(nbt);
    } 
  }
  ...
  protected NBTTagList func_96496_a() {
    ...
    for (ScorePlayerTeam scoreplayerteam : this.theScoreboard.getTeams()) {
      ...
      for (String s : scoreplayerteam.getMembershipCollection())
        nbttaglist1.appendTag((NBTBase)new NBTTagString(s)); 
      nbttagcompound.setTag("Players", (NBTBase)nbttaglist1);
  ...
  protected void func_96497_d(NBTTagCompound p_96497_1_) {
    ...
    if (flag)
      p_96497_1_.setTag("DisplaySlots", (NBTBase)nbttagcompound); 
  }
