...
public class WorldInfo {
  ...
  private void updateTagCompound(NBTTagCompound nbt, NBTTagCompound playerNbt) {
    ...
    nbt.setTag("GameRules", (NBTBase)this.theGameRules.writeToNBT());
    if (playerNbt != null)
      nbt.setTag("Player", (NBTBase)playerNbt); 
  }
  ...
  public void addToCrashReport(CrashReportCategory category) {
    category.addCrashSectionCallable("Level seed", (Callable)new Object(this));
    category.addCrashSectionCallable("Level generator", (Callable)new Object(this));
    category.addCrashSectionCallable("Level generator options", (Callable)new Object(this));
    category.addCrashSectionCallable("Level spawn location", (Callable)new Object(this));
    category.addCrashSectionCallable("Level time", (Callable)new Object(this));
    category.addCrashSectionCallable("Level dimension", (Callable)new Object(this));
    category.addCrashSectionCallable("Level storage version", (Callable)new Object(this));
    category.addCrashSectionCallable("Level weather", (Callable)new Object(this));
    category.addCrashSectionCallable("Level game mode", (Callable)new Object(this));
  }
