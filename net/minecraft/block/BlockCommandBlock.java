...
public class BlockCommandBlock extends BlockContainer {
  ...
  public BlockCommandBlock() {
    ...
    setDefaultState(this.blockState.getBaseState().withProperty((IProperty)TRIGGERED, Boolean.valueOf(false)));
  }
  
  public TileEntity createNewTileEntity(World worldIn, int meta) {
    return (TileEntity)new TileEntityCommandBlock();
  }
  ...
  public IBlockState getStateFromMeta(int meta) {
    return getDefaultState().withProperty((IProperty)TRIGGERED, Boolean.valueOf(((meta & 0x1) > 0)));
  }
  ...
  protected BlockState createBlockState() {
    return new BlockState(this, new IProperty[] { (IProperty)TRIGGERED });
  }
  
  public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
    return getDefaultState().withProperty((IProperty)TRIGGERED, Boolean.valueOf(false));
  }
}
