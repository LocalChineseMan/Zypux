...
public class BlockTrapDoor extends Block {
  ...
  protected BlockTrapDoor(Material materialIn) {
    super(materialIn);
    setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, (Comparable)EnumFacing.NORTH).withProperty((IProperty)OPEN, Boolean.valueOf(false)).withProperty((IProperty)HALF, (Comparable)DoorHalf.BOTTOM));
    float f = 0.5F;
    float f1 = 1.0F;
  ...
  public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
    ...
    if (facing.getAxis().isHorizontal()) {
      ...
      iblockstate = iblockstate.withProperty((IProperty)HALF, (hitY > 0.5F) ? (Comparable)DoorHalf.TOP : (Comparable)DoorHalf.BOTTOM);
    } 
    return iblockstate;
  }
  ...
  public IBlockState getStateFromMeta(int meta) {
    return getDefaultState().withProperty((IProperty)FACING, (Comparable)getFacing(meta)).withProperty((IProperty)OPEN, Boolean.valueOf(((meta & 0x4) != 0))).withProperty((IProperty)HALF, ((meta & 0x8) == 0) ? (Comparable)DoorHalf.BOTTOM : (Comparable)DoorHalf.TOP);
  }
  ...
  protected BlockState createBlockState() {
    return new BlockState((Block)this, new IProperty[] { (IProperty)FACING, (IProperty)OPEN, (IProperty)HALF });
  }
  
  public enum BlockTrapDoor {
