...
public class Profiler {
  ...
  public List<Result> getProfilingData(String profilerName) {
    if (!this.profilingEnabled)
      return null; 
    long i = ((Long)this.profilingMap.getOrDefault("root", Long.valueOf(0L))).longValue();
    long j = ((Long)this.profilingMap.getOrDefault(profilerName, Long.valueOf(-1L))).longValue();
    ...
    this.profilingMap.replaceAll((s, v) -> Long.valueOf(((Long)this.profilingMap.get(s)).longValue() * 950L / 1000L));
    if ((float)k > f)
