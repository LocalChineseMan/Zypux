...
public class GuiCommandBlock extends GuiScreen {
  ...
  public void initGui() {
    ...
    this;
    this;
    this.buttonList.add(this.doneBtn = new GuiButton(0, width / 2 - 4 - 150, height / 4 + 120 + 12, 150, 20, I18n.format("gui.done", new Object[0])));
    this;
    this;
    this.buttonList.add(this.cancelBtn = new GuiButton(1, width / 2 + 4, height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel", new Object[0])));
    this;
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this;
    drawCenteredString(this.fontRendererObj, I18n.format("advMode.setCommand", new Object[0]), width / 2, 20, 16777215);
    this;
    drawString(this.fontRendererObj, I18n.format("advMode.command", new Object[0]), width / 2 - 150, 37, 10526880);
    this.commandTextField.drawTextBox();
    int i = 75;
    int j = 0;
    this;
    drawString(this.fontRendererObj, I18n.format("advMode.nearestPlayer", new Object[0]), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
    this;
    drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
    this;
    drawString(this.fontRendererObj, I18n.format("advMode.allPlayers", new Object[0]), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
    this;
    drawString(this.fontRendererObj, I18n.format("advMode.allEntities", new Object[0]), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
    this;
    ...
    if (this.previousOutputTextField.getText().length() > 0) {
      ...
      this;
      drawString(this.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]), width / 2 - 150, i, 10526880);
