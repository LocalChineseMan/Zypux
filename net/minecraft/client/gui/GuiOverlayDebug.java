...
public class GuiOverlayDebug extends Gui {
  ...
  public void renderDebugInfo(ScaledResolution scaledResolutionIn) {
    ...
    if (this.mc.gameSettings.showLagometerR)
      renderLagometer(); 
    ...
    if (this.mc.theWorld != null && this.mc.theWorld.isBlockLoaded(blockpos)) {
      ...
      if (this.mc.isIntegratedServerRunning() && this.mc.getIntegratedServer() != null) {
        ...
        if (entityplayermp != null) {
          DifficultyInstance difficultyinstance1 = this.mc.getIntegratedServer().getDifficultyAsync(entityplayermp.worldObj, new BlockPos((Entity)entityplayermp));
  ...
  protected List<String> getDebugInfoRight() {
    ...
    if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
      ...
      for (UnmodifiableIterator<Map.Entry<IProperty, Comparable>> unmodifiableIterator = iblockstate.getProperties().entrySet().iterator(); unmodifiableIterator.hasNext(); ) {
