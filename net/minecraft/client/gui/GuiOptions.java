...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
  ...
  public void initGui() {
    ...
    if (this.mc.theWorld != null) {
      ...
      this;
      this;
      this.field_175357_i = new GuiButton(108, width / 2 - 155 + i % 2 * 160, height / 6 - 12 + 24 * (i >> 1), 150, 20, func_175355_a(enumdifficulty));
      ...
      this;
      this;
      GuiOptionButton guioptionbutton1 = new GuiOptionButton(GameSettings.Options.enumFloat.returnEnumOrdinal(), width / 2 - 155 + i % 2 * 160, height / 6 - 12 + 24 * (i >> 1), GameSettings.Options.enumFloat, this.game_settings_1.getKeyBinding(GameSettings.Options.enumFloat));
    ...
    this.buttonList.add(new GuiButton(8675309, width / 2 + 5, height / 6 + 48 - 6, 150, 20, "Super Secret Settings...") {
          public void playPressSound(SoundHandler soundHandlerIn) {
            ...
            if (soundeventaccessorcomposite != null)
              soundHandlerIn.playSound((ISound)PositionedSoundRecord.create(soundeventaccessorcomposite.getSoundEventLocation(), 0.5F)); 
          }
        });
    this;
    this;
  ...
  public String func_175355_a(EnumDifficulty p_175355_1_) {
    ...
    chatComponentText.appendSibling((IChatComponent)new ChatComponentTranslation("options.difficulty", new Object[0]));
    chatComponentText.appendText(": ");
    chatComponentText.appendSibling((IChatComponent)new ChatComponentTranslation(p_175355_1_.getDifficultyResourceKey(), new Object[0]));
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.enabled) {
      ...
      if (button.id == 101) {
        this.mc.gameSettings.saveOptions();
        this.mc.displayGuiScreen((GuiScreen)new GuiVideoSettings(this, this.game_settings_1));
      } 
      if (button.id == 100) {
        this.mc.gameSettings.saveOptions();
      ...
      if (button.id == 107) {
        ...
        if (istream.func_152936_l() && istream.func_152928_D()) {
          this.mc.displayGuiScreen((GuiScreen)new GuiStreamOptions(this, this.game_settings_1));
        } else {
