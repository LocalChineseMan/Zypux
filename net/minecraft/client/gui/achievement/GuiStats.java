...
public class GuiStats extends GuiScreen implements IProgressMeter {
  ...
  public void createButtons() {
    ...
    this;
    GuiButton guibutton;
    this.buttonList.add(guibutton = new GuiButton(2, width / 2 - 80, height - 52, 80, 20, I18n.format("stat.blocksButton", new Object[0])));
    this;
    this;
    GuiButton guibutton1;
    this.buttonList.add(guibutton1 = new GuiButton(3, width / 2, height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0])));
    this;
    this;
    GuiButton guibutton2;
    this.buttonList.add(guibutton2 = new GuiButton(4, width / 2 + 80, height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0])));
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.enabled)
      if (button.id == 0) {
        ...
        this.displaySlot = (GuiSlot)this.itemStats;
      } else if (button.id == 2) {
  ...
  class StatsBlock extends Stats {
    public StatsBlock(Minecraft mcIn) {
      ...
      for (StatCrafting statcrafting : StatList.objectMineStats) {
        ...
        if (GuiStats.this.field_146546_t.readStat((StatBase)statcrafting) > 0) {
          flag = true;
      ...
      this.statSorter = new Comparator<StatCrafting>() {
          public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
            ...
            if (statbase != null || statbase1 != null) {
              ...
              if (l != i1)
                return (l - i1) * GuiStats.StatsBlock.this.field_148215_p; 
            } 
            return j - k;
          }
        };
    ...
    protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
      ...
      func_148209_a((StatBase)statcrafting, p_180791_2_ + 215, p_180791_3_, (entryID % 2 == 0));
    }
  ...
  class StatsItem extends Stats {
    public StatsItem(Minecraft mcIn) {
      ...
      this.statSorter = (Comparator)new Object(this, GuiStats.this);
    }
