...
public class GuiScreenDemo extends GuiScreen {
  ...
  public void initGui() {
    ...
    this;
    this;
    this.buttonList.add(new GuiButton(1, width / 2 - 116, height / 2 + 62 + i, 114, 20, I18n.format("demo.help.buy", new Object[0])));
    this;
    this;
    this.buttonList.add(new GuiButton(2, width / 2 + 2, height / 2 + 62 + i, 114, 20, I18n.format("demo.help.later", new Object[0])));
  }
