...
public class GuiWinGame extends GuiScreen {
  ...
  public void updateScreen() {
    ...
    this;
    this;
    float f = (this.field_146579_r + height + height + 24) / this.field_146578_s;
  ...
  private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
    ...
    this;
    float f1 = height - (this.field_146581_h + p_146575_3_) * 0.5F * this.field_146578_s;
    float f2 = 0.015625F;
    float f3 = (this.field_146581_h + p_146575_3_ - 0.0F) * 0.02F;
    this;
    this;
    float f4 = (this.field_146579_r + height + height + 24) / this.field_146578_s;
    ...
    this;
    worldrenderer.pos(i, height, this.zLevel).tex((i * f2), (f * f2)).color(f3, f3, f3, 1.0F).endVertex();
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    for (int i1 = 0; i1 < this.field_146582_i.size(); i1++) {
      if (i1 == this.field_146582_i.size() - 1) {
        this;
        float f1 = l + f - (height / 2 - 6);
        if (f1 < 0.0F)
          GlStateManager.translate(0.0F, -f1, 0.0F); 
      } 
      this;
      if (l + f + 12.0F + 8.0F > 0.0F && l + f < height) {
