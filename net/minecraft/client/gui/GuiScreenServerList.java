...
public class GuiScreenServerList extends GuiScreen {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this;
    drawCenteredString(this.fontRendererObj, I18n.format("selectServer.direct", new Object[0]), width / 2, 20, 16777215);
    this;
    drawString(this.fontRendererObj, I18n.format("addServer.enterIp", new Object[0]), width / 2 - 100, 100, 10526880);
