...
public class GuiScreenAddServer extends GuiScreen {
  ...
  public GuiScreenAddServer(GuiScreen p_i1033_1_, ServerData p_i1033_2_) {
    this.field_181032_r = (p_apply_1_ -> {
  ...
  public void initGui() {
    ...
    this;
    this;
    this.buttonList.add(this.serverResourcePacks = new GuiButton(2, width / 2 - 100, height / 4 + 72, I18n.format("addServer.resourcePack", new Object[0]) + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
    this;
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this;
    drawCenteredString(this.fontRendererObj, I18n.format("addServer.title", new Object[0]), width / 2, 17, 16777215);
    this;
    drawString(this.fontRendererObj, I18n.format("addServer.enterName", new Object[0]), width / 2 - 100, 53, 10526880);
    this;
    drawString(this.fontRendererObj, I18n.format("addServer.enterIp", new Object[0]), width / 2 - 100, 94, 10526880);
