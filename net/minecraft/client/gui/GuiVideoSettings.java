...
public class GuiVideoSettings extends GuiScreenOF {
  ...
  private final TooltipManager tooltipManager = new TooltipManager((GuiScreen)this, (TooltipProvider)new TooltipProviderOptions());
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    String s = "OptiFine HD M5 Ultra";
    drawString(this.fontRendererObj, s, 2, height - 10, 8421504);
    String s2 = "Minecraft 1.8.9";
    int i = this.fontRendererObj.getStringWidth(s2);
    drawString(this.fontRendererObj, s2, width - i - 2, height - 10, 8421504);
