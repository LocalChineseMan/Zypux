...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
  ...
  public void initGui() {
    ...
    this;
    this.buttonList.add(this.field_175344_w = new GuiButton(303, width - 100, 5, 80, 20, I18n.format("createWorld.customize.custom.next", new Object[0])));
    this;
    this;
    this.buttonList.add(this.field_175346_u = new GuiButton(304, width / 2 - 187, height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults", new Object[0])));
    this;
    this;
    this.buttonList.add(this.field_175347_t = new GuiButton(301, width / 2 - 92, height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize", new Object[0])));
    this;
    this;
    this.buttonList.add(this.field_175350_z = new GuiButton(305, width / 2 + 3, height - 27, 90, 20, I18n.format("createWorld.customize.custom.presets", new Object[0])));
    this;
    this;
    this.buttonList.add(this.field_175348_s = new GuiButton(300, width / 2 + 98, height - 27, 90, 20, I18n.format("gui.done", new Object[0])));
  ...
  public void func_175319_a(int p_175319_1_, String p_175319_2_) {
    ...
    if (f1 != f && f != 0.0F)
      ((GuiTextField)this.field_175349_r.func_178061_c(p_175319_1_)).setText(func_175330_b(p_175319_1_, f1)); 
    ...
    if (button.enabled) {
      ...
      switch (button.id) {
        case 300:
          ...
          break;
        case 301:
          for (i = 0; i < this.field_175349_r.getSize(); i++) {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if (this.field_175339_B != 0) {
      this;
      this;
      drawRect(0, 0, width, height, -2147483648);
      this;
      this;
      ...
      tessellator.draw();
      this;
      drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirmTitle", new Object[0]), width / 2, 105, 16777215);
      this;
      drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm1", new Object[0]), width / 2, 125, 16777215);
      this;
      drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm2", new Object[0]), width / 2, 135, 16777215);
