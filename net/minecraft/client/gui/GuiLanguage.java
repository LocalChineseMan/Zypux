...
public class GuiLanguage extends GuiScreen {
  ...
  public void initGui() {
    ...
    this;
    this;
    this.buttonList.add(this.confirmSettingsBtn = new GuiOptionButton(6, width / 2 - 155 + 160, height - 38, I18n.format("gui.done", new Object[0])));
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this;
    drawCenteredString(this.fontRendererObj, I18n.format("options.language", new Object[0]), width / 2, 16, 16777215);
    this;
    this;
    drawCenteredString(this.fontRendererObj, "(" + I18n.format("options.languageWarning", new Object[0]) + ")", width / 2, height - 56, 8421504);
