...
public class GuiTwitchUserMode extends GuiScreen {
  ...
  public GuiTwitchUserMode(IStream streamIn, ChatUserInfo p_i1064_2_) {
    ...
    this.field_152338_i = (IChatComponent)new ChatComponentText(p_i1064_2_.displayName);
  ...
  public static List<IChatComponent> func_152328_a(Set<ChatUserMode> p_152328_0_, Set<ChatUserSubscription> p_152328_1_, IStream p_152328_2_) {
    ...
    for (ChatUserSubscription chatusersubscription : p_152328_1_) {
      ...
      if (ichatcomponent2 != null) {
        ChatComponentText chatComponentText = new ChatComponentText("- ");
        chatComponentText.appendSibling(ichatcomponent2);
        list.add(chatComponentText);
      } 
    } 
    return list;
  ...
  public void initGui() {
    ...
    int j = i - 130;
    this;
    this.buttonList.add(new GuiButton(1, i * 0 + j / 2, height - 70, 130, 20, I18n.format("stream.userinfo.timeout", new Object[0])));
    this;
    this.buttonList.add(new GuiButton(0, i * 1 + j / 2, height - 70, 130, 20, I18n.format("stream.userinfo.ban", new Object[0])));
    this;
    this.buttonList.add(new GuiButton(2, i * 2 + j / 2, height - 70, 130, 20, I18n.format("stream.userinfo.mod", new Object[0])));
    this;
    this.buttonList.add(new GuiButton(5, i * 0 + j / 2, height - 45, 130, 20, I18n.format("gui.cancel", new Object[0])));
    this;
    this.buttonList.add(new GuiButton(3, i * 1 + j / 2, height - 45, 130, 20, I18n.format("stream.userinfo.unban", new Object[0])));
    this;
    this.buttonList.add(new GuiButton(4, i * 2 + j / 2, height - 45, 130, 20, I18n.format("stream.userinfo.unmod", new Object[0])));
    int k = 0;
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this;
    drawCenteredString(this.fontRendererObj, this.field_152338_i.getUnformattedText(), width / 2, 70, 16777215);
    int i = 80;
    for (IChatComponent ichatcomponent : this.field_152332_r) {
      drawString(this.fontRendererObj, ichatcomponent.getFormattedText(), this.field_152334_t, i, 16777215);
