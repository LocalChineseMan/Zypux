...
public class GuiStreamUnavailable extends GuiScreen {
  ...
  public void initGui() {
    if (this.field_152323_r.isEmpty()) {
      this;
      this.field_152323_r.addAll(this.fontRendererObj.listFormattedStringToWidth(this.field_152326_h.func_152561_a().getFormattedText(), (int)(width * 0.75F)));
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    this;
    int i = Math.max((int)(height * 0.85D / 2.0D - ((this.field_152323_r.size() * this.fontRendererObj.FONT_HEIGHT) / 2.0F)), 50);
    this;
    drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), width / 2, i - this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
    for (String s : this.field_152323_r) {
      this;
      drawCenteredString(this.fontRendererObj, s, width / 2, i, 10526880);
  ...
  public static void func_152321_a(GuiScreen p_152321_0_) {
    ...
    if (!OpenGlHelper.framebufferSupported) {
      ...
      List<ChatComponentTranslation> list1 = Collections.singletonList(new ChatComponentTranslation("stream.unavailable.initialization_failure.extra", new Object[] { ErrorCode.getString(istream.func_152912_E()) }));
