...
public class GuiScreenBook extends GuiScreen {
  ...
  public void initGui() {
    ...
    if (this.bookIsUnsigned) {
      this;
      this.buttonList.add(this.buttonSign = new GuiButton(3, width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.signButton", new Object[0])));
      this;
      this.buttonList.add(this.buttonDone = new GuiButton(0, width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.done", new Object[0])));
      this;
      this.buttonList.add(this.buttonFinalize = new GuiButton(5, width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.finalizeButton", new Object[0])));
      this;
      this.buttonList.add(this.buttonCancel = new GuiButton(4, width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.cancel", new Object[0])));
    } else {
      this;
      this.buttonList.add(this.buttonDone = new GuiButton(0, width / 2 - 100, 4 + this.bookImageHeight, 200, 20, I18n.format("gui.done", new Object[0])));
    } 
    this;
      ...
      if (this.bookPages != null) {
        ...
        if (publish) {
          ...
          for (int i = 0; i < this.bookPages.tagCount(); i++) {
            ...
            s1 = IChatComponent.Serializer.componentToJson((IChatComponent)chatComponentText);
