...
public class TextureUtil {
  ...
  private static int blendColorComponent(int p_147944_0_, int p_147944_1_, int p_147944_2_, int p_147944_3_, int p_147944_4_) {
    float f = (float)Math.pow(((p_147944_0_ >> p_147944_4_ & 0xFF) / 255.0F), 2.2D);
    float f1 = (float)Math.pow(((p_147944_1_ >> p_147944_4_ & 0xFF) / 255.0F), 2.2D);
    float f2 = (float)Math.pow(((p_147944_2_ >> p_147944_4_ & 0xFF) / 255.0F), 2.2D);
    float f3 = (float)Math.pow(((p_147944_3_ >> p_147944_4_ & 0xFF) / 255.0F), 2.2D);
  ...
  private static void uploadTextureSub(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_, int p_147947_4_, int p_147947_5_, boolean p_147947_6_, boolean p_147947_7_, boolean p_147947_8_) {
    ...
    int k;
    for (k = 0; k < p_147947_2_ * p_147947_3_; k += p_147947_2_ * j) {
      int l = k / p_147947_2_;
  ...
  public static void allocateTextureImpl(int p_180600_0_, int p_180600_1_, int p_180600_2_, int p_180600_3_) {
    Object<TextureUtil> object = (Object<TextureUtil>)TextureUtil.class;
    if (Reflector.SplashScreen.exists())
      object = (Object<TextureUtil>)Reflector.SplashScreen.getTargetClass(); 
    synchronized (object) {
