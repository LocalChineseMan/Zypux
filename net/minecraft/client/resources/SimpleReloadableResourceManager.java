...
public class SimpleReloadableResourceManager implements IReloadableResourceManager {
  ...
  public void reloadResources(List<IResourcePack> resourcesPacksList) {
    clearResources();
    logger.info("Reloading ResourceManager: " + joinerResourcePacks.join((Iterable)resourcesPacksList.stream().map(IResourcePack::getPackName).collect(Collectors.toList())));
