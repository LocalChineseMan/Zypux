...
public class GameSettings {
  ...
  private static final String[] PERFORMANCE = new String[] { "options.off", "options.graphics.fast", "options.graphics.fancy" };
  ...
  public GameSettings(Minecraft mcIn, File optionsFileIn) {
    this.keyBindings = (KeyBinding[])ArrayUtils.addAll((Object[])new KeyBinding[] { 
          this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, 
          this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindStreamStartStop, this.keyBindStreamPauseUnpause, 
          this.keyBindStreamCommercials, this.keyBindStreamToggleMic, this.keyBindFullscreen, this.keyBindSpectatorOutlines }, (Object[])this.keyBindsHotbar);
    ...
    this.keyBindings = (KeyBinding[])ArrayUtils.add((Object[])this.keyBindings, this.ofKeyBindZoom);
  ...
  public String getKeyBinding(Options settingOption) {
    ...
    if (settingOption.getEnumFloat()) {
      ...
      return (settingOption == Options.MIPMAP_LEVELS && f1 >= 4.0D) ? (s1 + Lang.get("of.general.max")) : ((settingOption == Options.SENSITIVITY) ? ((f == 0.0F) ? (s1 + I18n.format("options.sensitivity.min", new Object[0])) : ((f == 1.0F) ? (s1 + I18n.format("options.sensitivity.max", new Object[0])) : (s1 + (int)(f * 200.0F) + "%"))) : ((settingOption == Options.FOV) ? ((f1 == 70.0F) ? (s1 + I18n.format("options.fov.min", new Object[0])) : ((f1 == 110.0F) ? (s1 + I18n.format("options.fov.max", new Object[0])) : (s1 + (int)f1))) : ((settingOption == Options.FRAMERATE_LIMIT) ? ((f1 == settingOption.$VALUES) ? (s1 + I18n.format("options.framerateLimit.max", new Object[0])) : (s1 + (int)f1 + " fps")) : ((settingOption == Options.RENDER_CLOUDS) ? ((f1 == settingOption.valueMax) ? (s1 + I18n.format("options.cloudHeight.min", new Object[0])) : (s1 + ((int)f1 + 128))) : ((settingOption == Options.GAMMA) ? ((f == 0.0F) ? (s1 + I18n.format("options.gamma.min", new Object[0])) : ((f == 1.0F) ? (s1 + I18n.format("options.gamma.max", new Object[0])) : (s1 + "+" + (int)(f * 100.0F) + "%"))) : ((settingOption == Options.SATURATION) ? (s1 + (int)(f * 400.0F) + "%") : ((settingOption == Options.CHAT_OPACITY) ? (s1 + (int)(f * 90.0F + 10.0F) + "%") : ((settingOption == Options.CHAT_HEIGHT_UNFOCUSED) ? (s1 + GuiNewChat.calculateChatboxHeight(f) + "px") : ((settingOption == Options.CHAT_HEIGHT_FOCUSED) ? (s1 + GuiNewChat.calculateChatboxHeight(f) + "px") : ((settingOption == Options.CHAT_WIDTH) ? (s1 + GuiNewChat.calculateChatboxWidth(f) + "px") : ((settingOption == Options.RENDER_DISTANCE) ? (s1 + (int)f1 + " chunks") : ((settingOption == Options.MIPMAP_LEVELS) ? ((f1 == 0.0F) ? (s1 + I18n.format("options.off", new Object[0])) : (s1 + (int)f1)) : ((settingOption == Options.STREAM_FPS) ? (s1 + TwitchStream.formatStreamFps(f) + " fps") : ((settingOption == Options.STREAM_KBPS) ? (s1 + TwitchStream.formatStreamKbps(f) + " Kbps") : ((settingOption == Options.STREAM_BYTES_PER_PIXEL) ? (s1 + String.format("%.3f bpp", new Object[] { Float.valueOf(TwitchStream.formatStreamBps(f)) })) : ((f == 0.0F) ? (s1 + I18n.format("options.off", new Object[0])) : (s1 + (int)(f * 100.0F) + "%")))))))))))))))));
    } 
    ...
    if (settingOption == Options.RENDER_CLOUDS)
      return s1 + getTranslation(PERFORMANCE, this.clouds); 
  ...
  public Set<EnumPlayerModelParts> getModelParts() {
    return (Set<EnumPlayerModelParts>)ImmutableSet.copyOf(this.setModelParts);
  }
  ...
  private float getOptionFloatValueOF(Options p_getOptionFloatValueOF_1_) {
    ...
    if (p_getOptionFloatValueOF_1_ == Options.FRAMERATE_LIMIT)
      return (this.limitFramerate == Options.FRAMERATE_LIMIT.getValueMax() && this.enableVsync) ? 0.0F : this.limitFramerate; 
  ...
  private void updateWaterOpacity() {
    ...
    ClearWater.updateWaterOpacity(this, (World)this.mc.theWorld);
  }
  ...
  public enum Options {
    ...
    public float normalizeValue(float value) {
      return MathHelper.clamp_float((snapToStepClamp(value) - this.valueMax) / (this.$VALUES - this.valueMax), 0.0F, 1.0F);
    }
    
    public float denormalizeValue(float value) {
      return snapToStepClamp(this.valueMax + (this.$VALUES - this.valueMax) * MathHelper.clamp_float(value, 0.0F, 1.0F));
    }
