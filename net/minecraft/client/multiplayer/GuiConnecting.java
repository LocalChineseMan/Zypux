...
public class GuiConnecting extends GuiScreen {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    if (this.networkManager == null) {
      this;
      this;
      drawCenteredString(this.fontRendererObj, I18n.format("connect.connecting", new Object[0]), width / 2, height / 2 - 50, 16777215);
    } else {
      this;
      this;
      drawCenteredString(this.fontRendererObj, I18n.format("connect.authorizing", new Object[0]), width / 2, height / 2 - 50, 16777215);
    } 
