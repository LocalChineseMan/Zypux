...
public class Realms {
  ...
  public static void setScreen(RealmsScreen p_setScreen_0_) {
    Minecraft.getMinecraft().displayGuiScreen((GuiScreen)p_setScreen_0_.getProxy());
  }
  ...
  public static boolean inTitleScreen() {
    return ((Minecraft.getMinecraft()).currentScreen != null && (Minecraft.getMinecraft()).currentScreen instanceof net.minecraft.client.gui.GuiMainMenu);
  }
}
