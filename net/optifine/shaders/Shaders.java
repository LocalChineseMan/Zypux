...
public class Shaders {
  ...
  private static ShaderOption[] getShaderOptionsRest(Map<String, ScreenShaderOptions> mapScreens, ShaderOption[] ops) {
    ...
    return list.<ShaderOption>toArray(new ShaderOption[list.size()]);
  }
  ...
  private static ShaderOption[] getVisibleOptions(ShaderOption[] ops) {
    ...
    return list.<ShaderOption>toArray(new ShaderOption[0]);
  }
  ...
  private static void setupFrameBuffer() {
    ...
    for (int k = 0; k < usedColorBuffers; k++) {
      ...
      GL11.glTexImage2D(3553, 0, gbuffersFormat[k], renderWidth, renderHeight, 0, getPixelFormat(gbuffersFormat[k]), 33639, (FloatBuffer)null);
    ...
    for (int l = 0; l < usedColorBuffers; l++) {
      ...
      GL11.glTexParameteri(3553, 10241, 9729);
      GL11.glTexParameteri(3553, 10240, 9729);
      GL11.glTexImage2D(3553, 0, gbuffersFormat[l], renderWidth, renderHeight, 0, getPixelFormat(gbuffersFormat[l]), 33639, (FloatBuffer)null);
      checkGLError("FT ca");
    } 
    ...
    if (i1 == 36058) {
      ...
      for (int j = 0; j < usedColorBuffers; j++) {
        ...
        GL11.glTexImage2D(3553, 0, 6408, renderWidth, renderHeight, 0, 32993, 33639, (FloatBuffer)null);
  ...
  private static void setupShadowFrameBuffer() {
    if (usedShadowDepthBuffers != 0) {
      ...
      for (int k = 0; k < usedShadowColorBuffers; k++) {
        ...
        GL11.glTexImage2D(3553, 0, 6408, shadowMapWidth, shadowMapHeight, 0, 32993, 33639, (FloatBuffer)null);
