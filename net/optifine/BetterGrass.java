...
public class BetterGrass {
  ...
  private static void loadProperties(TextureMap textureMap) {
    ...
    try {
      ...
      spriteGrass = registerSprite((Properties)propertiesOrdered, "texture.grass", "blocks/grass_top", textureMap);
      spriteGrassSide = registerSprite((Properties)propertiesOrdered, "texture.grass_side", "blocks/grass_side", textureMap);
      spriteMycelium = registerSprite((Properties)propertiesOrdered, "texture.mycelium", "blocks/mycelium_top", textureMap);
      spritePodzol = registerSprite((Properties)propertiesOrdered, "texture.podzol", "blocks/dirt_podzol_top", textureMap);
      spriteSnow = registerSprite((Properties)propertiesOrdered, "texture.snow", "blocks/snow", textureMap);
