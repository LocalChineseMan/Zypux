...
import ir.lecer.uwu.events.events.WorldChangedEvent;
...
public class RandomEntities {
  ...
  public static void worldChanged(World oldWorld, World newWorld) {
    WorldChangedEvent worldChangedEvent = new WorldChangedEvent(oldWorld, newWorld);
    worldChangedEvent.call();
    if (newWorld != null) {
  ...
  private static RandomEntityProperties parseProperties(ResourceLocation propLoc, ResourceLocation resLoc) {
    try {
      ...
      inputstream.close();
      RandomEntityProperties randomentityproperties = new RandomEntityProperties((Properties)propertiesOrdered, s, resLoc);
