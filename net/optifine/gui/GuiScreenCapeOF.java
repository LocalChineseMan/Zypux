...
public class GuiScreenCapeOF extends GuiScreenOF {
  ...
  public void initGui() {
    ...
    this;
    this;
    this.buttonList.add(new GuiButtonOF(210, width / 2 - 155, height / 6 + 24 * (i >> 1), 150, 20, I18n.format("of.options.capeOF.openEditor", new Object[0])));
    this;
    this;
    ...
    this;
    this;
    this.buttonCopyLink = new GuiButtonOF(230, width / 2 - 100, height / 6 + 24 * (i >> 1), 200, 20, I18n.format("of.options.capeOF.copyEditorLink", new Object[0]));
    this.buttonCopyLink.visible = (this.linkUrl != null);
    this.buttonList.add(this.buttonCopyLink);
    i += 4;
    this;
    this;
    this.buttonList.add(new GuiButtonOF(200, width / 2 - 100, height / 6 + 24 * (i >> 1), I18n.format("gui.done", new Object[0])));
  }
