...
public class CustomGuiProperties {
  ...
  public boolean matchesPos(EnumContainer ec, BlockPos pos, IBlockAccess blockAccess, GuiScreen screen) {
    ...
    switch (ec) {
      case BEACON:
        return matchesBeacon(pos, blockAccess);
      case CHEST:
        return matchesChest(pos, blockAccess);
      case DISPENSER:
        return matchesDispenser(pos, blockAccess);
    } 
    return true;
  }
  ...
  private EnumVariant getDispenserVariant(TileEntityDispenser ted) {
    return (ted instanceof net.minecraft.tileentity.TileEntityDropper) ? EnumVariant.DROPPER : EnumVariant.DISPENSER;
  }
  ...
  public boolean matchesEntity(EnumContainer ec, Entity entity, IBlockAccess blockAccess) {
    ...
    switch (ec) {
      case HORSE:
        return matchesHorse(entity, blockAccess);
      case VILLAGER:
        return matchesVillager(entity, blockAccess);
    } 
    return true;
  }
