...
public class CustomPanorama {
  ...
  public static void update() {
    ...
    if (astring.length > 1) {
      ...
      CustomPanoramaProperties custompanoramaproperties = new CustomPanoramaProperties(s, (Properties)propertiesOrdered);
    ...
    for (int i = 0; i < folders.length; i++) {
      ...
      try {
        ...
        if (inputstream != null) {
          ...
          aproperties[i] = (Properties)propertiesOrdered;
          inputstream.close();
        } 
