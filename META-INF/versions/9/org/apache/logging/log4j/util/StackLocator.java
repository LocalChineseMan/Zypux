...
public class StackLocator {
  ...
  public Class<?> getCallerClass(Class<?> sentinelClass, Predicate<Class<?>> callerPredicate) {
    ...
    return (Class)WALKER.walk(s -> (Class)s.map(StackWalker.StackFrame::getDeclaringClass).dropWhile(()).dropWhile(()).findFirst().orElse(null));
  }
  ...
  public Class<?> getCallerClass(String fqcn, String pkg) {
    return ((Optional)WALKER.walk(s -> s.dropWhile(()).dropWhile(()).dropWhile(()).findFirst()))
  ...
  public Class<?> getCallerClass(Class<?> anchor) {
    return ((Optional)WALKER.walk(s -> s.dropWhile(()).dropWhile(()).findFirst()))
  ...
  public Deque<Class<?>> getCurrentStackTrace() {
    ...
    return (Deque<Class<?>>)WALKER.walk(s -> {
          s.forEach(());
          return stack;
        });
  }
  ...
  public StackTraceElement calcLocation(String fqcnOfLogger) {
    return ((Optional)STACK_WALKER.walk(s -> s.dropWhile(()).dropWhile(()).findFirst()))
      
      .map(StackWalker.StackFrame::toStackTraceElement).orElse(null);
  }
  
  public StackTraceElement getStackTraceElement(int depth) {
    return ((Optional)STACK_WALKER.walk(s -> s.skip(depth).findFirst()))
      .map(StackWalker.StackFrame::toStackTraceElement).orElse(null);
  }
}
