...
public enum ErrorCode {
  ...
  static {
    s_Map = new HashMap<Integer, ErrorCode>();
    EnumSet<ErrorCode> enumSet = EnumSet.allOf(ErrorCode.class);
    for (ErrorCode errorCode : enumSet)
      s_Map.put(Integer.valueOf(errorCode.getValue()), errorCode); 
  }
  
  public static ErrorCode lookupValue(int paramInt) {
  ...
  public static boolean succeeded(ErrorCode paramErrorCode) {
    return (paramErrorCode.getValue() <= TTV_EC_SUCCESS.getValue());
  }
  
  public static boolean failed(ErrorCode paramErrorCode) {
    return (paramErrorCode.getValue() > TTV_EC_SUCCESS.getValue());
  }
  
  public static String getString(ErrorCode paramErrorCode) {
    Core core = Core.getInstance();
    if (core == null)
      return "Unknown error"; 
    return core.errorToString(paramErrorCode);
  }
}
