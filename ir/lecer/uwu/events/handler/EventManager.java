...
public class EventManager {
  ...
  private static void register(Method method, Object o) {
    ...
    final Data methodData = new Data(o, method, ((EventHandler)method.<EventHandler>getAnnotation(EventHandler.class)).value());
    TaskManager.async(() -> {
  ...
  private static boolean isMethodBad(Method method) {
    return ((method.getParameterTypes()).length != 1 || !method.isAnnotationPresent((Class)EventHandler.class));
  }
  ...
  private static final Map<Class<? extends Event>, ArrayHelper<Data>> REGISTRY_MAP = new ConcurrentHashMap<>();
}
