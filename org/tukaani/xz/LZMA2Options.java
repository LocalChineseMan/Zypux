...
public class LZMA2Options extends FilterOptions {
  ...
  public FinishableOutputStream getOutputStream(FinishableOutputStream paramFinishableOutputStream, ArrayCache paramArrayCache) {
    return (FinishableOutputStream)((this.mode == 0) ? new UncompressedLZMA2OutputStream(paramFinishableOutputStream, paramArrayCache) : new LZMA2OutputStream(paramFinishableOutputStream, this, paramArrayCache));
  }
  ...
  public InputStream getInputStream(InputStream paramInputStream, ArrayCache paramArrayCache) throws IOException {
    return new LZMA2InputStream(paramInputStream, this.dictSize, this.presetDict, paramArrayCache);
  }
