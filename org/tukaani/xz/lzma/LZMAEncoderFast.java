...
final class LZMAEncoderFast extends LZMAEncoder {
  ...
  static int getMemoryUsage(int paramInt1, int paramInt2, int paramInt3) {
    return LZEncoder.getMemoryUsage(paramInt1, Math.max(paramInt2, 1), 272, 273, paramInt3);
  }
  
  LZMAEncoderFast(RangeEncoder paramRangeEncoder, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, ArrayCache paramArrayCache) {
    super(paramRangeEncoder, LZEncoder.getInstance(paramInt4, Math.max(paramInt5, 1), 272, paramInt6, 273, paramInt7, paramInt8, paramArrayCache), paramInt1, paramInt2, paramInt3, paramInt4, paramInt6);
  }
