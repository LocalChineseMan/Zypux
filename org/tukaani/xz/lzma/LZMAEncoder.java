...
public abstract class LZMAEncoder extends LZMACoder {
  ...
  public static LZMAEncoder getInstance(RangeEncoder paramRangeEncoder, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, ArrayCache paramArrayCache) {
    switch (paramInt4) {
      case 1:
        return new LZMAEncoderFast(paramRangeEncoder, paramInt1, paramInt2, paramInt3, paramInt5, paramInt6, paramInt7, paramInt8, paramInt9, paramArrayCache);
      case 2:
        return new LZMAEncoderNormal(paramRangeEncoder, paramInt1, paramInt2, paramInt3, paramInt5, paramInt6, paramInt7, paramInt8, paramInt9, paramArrayCache);
    } 
    throw new IllegalArgumentException();
  }
  
  public void putArraysToCache(ArrayCache paramArrayCache) {
    this.lz.putArraysToCache(paramArrayCache);
  }
  ...
  public void encodeLZMA1EndMarker() throws IOException {
    int i = this.lz.getPos() - this.readAhead & this.posMask;
    this.rc.encodeBit(this.isMatch[this.state.get()], i, 1);
  ...
  private void encodeMatch(int paramInt1, int paramInt2, int paramInt3) throws IOException {
  ...
  private void encodeRepMatch(int paramInt1, int paramInt2, int paramInt3) throws IOException {
    if (paramInt1 == 0) {
      ...
      void encode() throws IOException {
        ...
        if (LZMAEncoder.this.state.isLiteral()) {
          do {
            int j = i >>> 8;
            int k = i >>> 7 & 0x1;
            LZMAEncoder.this.rc.encodeBit(this.probs, j, k);
            i <<= 1;
          } while (i < 65536);
        } else {
          int j = LZMAEncoder.this.lz.getByte(LZMAEncoder.this.reps[0] + 1 + LZMAEncoder.this.readAhead);
          int k = 256;
          do {
            j <<= 1;
            int n = j & k;
            int m = k + n + (i >>> 8);
            int i1 = i >>> 7 & 0x1;
            LZMAEncoder.this.rc.encodeBit(this.probs, m, i1);
            i <<= 1;
            k &= j ^ i ^ 0xFFFFFFFF;
          } while (i < 65536);
        } 
  ...
  class LengthEncoder extends LZMACoder.LengthCoder {
    ...
    void encode(int param1Int1, int param1Int2) throws IOException {
      param1Int1 -= 2;
      if (param1Int1 < 8) {
