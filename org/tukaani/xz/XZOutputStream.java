...
public class XZOutputStream extends FinishableOutputStream {
  ...
  public XZOutputStream(OutputStream paramOutputStream, FilterOptions paramFilterOptions, ArrayCache paramArrayCache) throws IOException {
    this(paramOutputStream, paramFilterOptions, 4, paramArrayCache);
  }
  ...
  public XZOutputStream(OutputStream paramOutputStream, FilterOptions paramFilterOptions, int paramInt, ArrayCache paramArrayCache) throws IOException {
    this(paramOutputStream, new FilterOptions[] { paramFilterOptions }, paramInt, paramArrayCache);
  }
  ...
  public XZOutputStream(OutputStream paramOutputStream, FilterOptions[] paramArrayOfFilterOptions, ArrayCache paramArrayCache) throws IOException {
    this(paramOutputStream, paramArrayOfFilterOptions, 4, paramArrayCache);
  }
  ...
  public XZOutputStream(OutputStream paramOutputStream, FilterOptions[] paramArrayOfFilterOptions, int paramInt) throws IOException {
    this(paramOutputStream, paramArrayOfFilterOptions, paramInt, ArrayCache.getDefaultCache());
  }
  
  public XZOutputStream(OutputStream paramOutputStream, FilterOptions[] paramArrayOfFilterOptions, int paramInt, ArrayCache paramArrayCache) throws IOException {
