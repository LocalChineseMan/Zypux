...
final class HC4 extends LZEncoder {
  ...
  HC4(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, ArrayCache paramArrayCache) {
    ...
    this.chain = paramArrayCache.getIntArray(this.cyclicSize, false);
  ...
  public void putArraysToCache(ArrayCache paramArrayCache) {
    paramArrayCache.putArray(this.chain);
  ...
  private int movePos() {
    ...
    if (i != 0) {
      if (++this.lzPos == Integer.MAX_VALUE) {
        ...
        normalize(this.chain, this.cyclicSize, j);
        this.lzPos -= j;
      } 
