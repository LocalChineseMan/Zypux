...
public abstract class LZEncoder {
  ...
  static void normalize(int[] paramArrayOfint, int paramInt1, int paramInt2) {
    for (byte b = 0; b < paramInt1; b++) {
      if (paramArrayOfint[b] <= paramInt2) {
        paramArrayOfint[b] = 0;
      } else {
        paramArrayOfint[b] = paramArrayOfint[b] - paramInt2;
      } 
    } 
  }
  ...
  public static LZEncoder getInstance(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, ArrayCache paramArrayCache) {
    switch (paramInt6) {
      case 4:
        return new HC4(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt7, paramArrayCache);
      case 20:
        return new BT4(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt7, paramArrayCache);
    } 
    throw new IllegalArgumentException();
  }
  
  LZEncoder(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, ArrayCache paramArrayCache) {
    this.bufSize = getBufSize(paramInt1, paramInt2, paramInt3, paramInt5);
  ...
  public int fillWindow(byte[] paramArrayOfbyte, int paramInt1, int paramInt2) {
    ...
    if (this.readPos >= this.bufSize - this.keepSizeAfter)
      moveWindow(); 
    if (paramInt2 > this.bufSize - this.writePos)
      paramInt2 = this.bufSize - this.writePos; 
