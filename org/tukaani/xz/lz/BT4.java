...
final class BT4 extends LZEncoder {
  ...
  BT4(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, ArrayCache paramArrayCache) {
    super(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramArrayCache);
    this.cyclicSize = paramInt1 + 1;
    this.lzPos = this.cyclicSize;
    this.hash = new Hash234(paramInt1, paramArrayCache);
    this.tree = paramArrayCache.getIntArray(this.cyclicSize * 2, false);
  ...
  public void putArraysToCache(ArrayCache paramArrayCache) {
    paramArrayCache.putArray(this.tree);
    this.hash.putArraysToCache(paramArrayCache);
    super.putArraysToCache(paramArrayCache);
  }
  ...
  private int movePos() {
    ...
    if (i != 0) {
      if (++this.lzPos == Integer.MAX_VALUE) {
        ...
        normalize(this.tree, this.cyclicSize * 2, j);
        this.lzPos -= j;
      } 
