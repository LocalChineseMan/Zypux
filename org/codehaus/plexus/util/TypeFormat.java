...
public final class TypeFormat {
  ...
  public static boolean parseBoolean(CharSequence chars) {
    return (chars.length() == 4 && (chars.charAt(0) == 't' || chars.charAt(0) == 'T') && (chars
      .charAt(1) == 'r' || chars.charAt(1) == 'R') && (chars
      .charAt(2) == 'u' || chars.charAt(2) == 'U') && (chars
      .charAt(3) == 'e' || chars.charAt(3) == 'E'));
  }
  ...
  private static java.lang.String[] LEADING_ZEROS = new java.lang.String[] { "0.", "0.0", "0.00" };
