...
public class MXSerializer implements XmlSerializer {
  ...
  public XmlSerializer endTag(String namespace, String name) throws IOException {
    ...
    if (namespace != this.elNamespace[this.depth])
      throw new IllegalArgumentException("expected namespace " + printable(this.elNamespace[this.depth]) + " and not " + 
    ...
    if ((!this.namesInterned && !name.equals(this.elName[this.depth])) || (this.namesInterned && name != this.elName[this.depth]))
      throw new IllegalArgumentException("expected element name " + printable(this.elName[this.depth]) + " and not " + 
