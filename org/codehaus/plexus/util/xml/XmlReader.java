...
public class XmlReader extends Reader {
  ...
  public XmlReader(File file) throws IOException {
    this(Files.newInputStream(file.toPath(), new java.nio.file.OpenOption[0]));
  }
  ...
  private static boolean isAppXml(String mime) {
    return (mime != null && (mime.equals("application/xml") || mime.equals("application/xml-dtd") || mime
  ...
  private static boolean isTextXml(String mime) {
    return (mime != null && (mime.equals("text/xml") || mime.equals("text/xml-external-parsed-entity") || (mime
