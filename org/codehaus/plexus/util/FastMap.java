...
public class FastMap<K, V> implements Map<K, V>, Cloneable, Serializable {
  ...
  public void setCapacity(int newCapacity) {
    if (newCapacity > this._capacity) {
      for (int i = this._capacity; i < newCapacity; i++) {
        EntryImpl<Object, Object> entry = new EntryImpl<>();
  ...
  public Collection values() {
    return (Collection)this._values;
  }
  ...
  public Set keySet() {
    return (Set)this._keySet;
  }
  
  private class null implements Iterator {
    FastMap.EntryImpl after = this.this$1.this$0._mapFirst;
    
    FastMap.EntryImpl before;
    
    public void remove() {
      this.this$1.this$0.removeEntry(this.before);
    }
  ...
  private static final class EntryImpl<K, V> implements Map.Entry<K, V> {
    ...
    public boolean equals(Object that) {
      if (that instanceof Map.Entry) {
        ...
        return (this._key.equals(entry.getKey()) && ((this._value != null) ? this._value
          .equals(entry.getValue()) : (entry.getValue() == null)));
      } 
      return false;
    }
