...
final class AWTUtil {
  ...
  public static Robot createRobot(final Component component) {
    try {
      return AccessController.<Robot>doPrivileged(new PrivilegedExceptionAction<Robot>() {
  ...
  private static Point getPointerLocation(Component component) {
    try {
      ...
      if (config != null) {
        PointerInfo pointer_info = AccessController.<PointerInfo>doPrivileged(new PrivilegedExceptionAction<PointerInfo>() {
