...
final class MacOSXNativeKeyboard extends EventQueue {
  ...
  private int getMappedKeyCode(short key_code) {
    if (this.nativeToLwjglMap.containsKey(Short.valueOf(key_code)))
      return ((Integer)this.nativeToLwjglMap.get(Short.valueOf(key_code))).intValue(); 
    return -1;
  }
  
  public void keyPressed(int key_code, String chars, long nanos) {
    int character = (chars == null || chars.length() == 0) ? 0 : chars.charAt(0);
