...
final class LinuxMouse {
  ...
  private void reset(boolean grab, boolean warp_pointer) {
    ...
    this.last_x = win_x;
    this.last_y = transformY(win_y);
    doHandlePointerMotion(grab, warp_pointer, root_window, root_x, root_y, win_x, win_y, this.last_event_nanos);
  }
  ...
  public void setCursorPosition(int x, int y) {
    nWarpCursor(this.display, this.window, x, transformY(y));
  }
