...
public class DefaultHttpRequestRetryHandler implements HttpRequestRetryHandler {
  ...
  public DefaultHttpRequestRetryHandler(int retryCount, boolean requestSentRetryEnabled) {
    this(retryCount, requestSentRetryEnabled, Arrays.asList((Class<? extends IOException>[])new Class[] { InterruptedIOException.class, UnknownHostException.class, ConnectException.class, SSLException.class }));
  }
  ...
  protected boolean handleAsIdempotent(HttpRequest request) {
    return !(request instanceof org.apache.http.HttpEntityEnclosingRequest);
  }
