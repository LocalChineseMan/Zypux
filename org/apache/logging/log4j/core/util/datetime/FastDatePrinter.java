...
public class FastDatePrinter implements DatePrinter, Serializable {
  ...
  private void init() {
    ...
    this.mRules = rulesList.<Rule>toArray(Rule.EMPTY_ARRAY);
    int len = 0;
  ...
  protected List<Rule> parsePattern() {
    ...
    for (int i = 0; i < length; i++) {
      ...
      switch (c) {
        case 'G':
          rule1 = new TextField(0, ERAs);
          break;
        case 'Y':
        case 'y':
          if (tokenLen == 2) {
            rule1 = TwoDigitYearField.INSTANCE;
          } else {
            rule1 = selectNumberRule(1, (tokenLen < 4) ? 4 : tokenLen);
          } 
          if (c == 'Y')
            rule1 = new WeekYear((NumberRule)rule1); 
          break;
        case 'M':
          if (tokenLen >= 4) {
            rule1 = new TextField(2, months);
            break;
          } 
          if (tokenLen == 3) {
            rule1 = new TextField(2, shortMonths);
            break;
          } 
          if (tokenLen == 2) {
            rule1 = TwoDigitMonthField.INSTANCE;
            break;
          } 
          rule1 = UnpaddedMonthField.INSTANCE;
          break;
        case 'd':
          rule1 = selectNumberRule(5, tokenLen);
          break;
        case 'h':
          rule1 = new TwelveHourField(selectNumberRule(10, tokenLen));
          break;
        case 'H':
          rule1 = selectNumberRule(11, tokenLen);
          break;
        case 'm':
          rule1 = selectNumberRule(12, tokenLen);
          break;
        case 's':
          rule1 = selectNumberRule(13, tokenLen);
          break;
        case 'S':
          rule1 = selectNumberRule(14, tokenLen);
          break;
        case 'E':
          rule1 = new TextField(7, (tokenLen < 4) ? shortWeekdays : weekdays);
          break;
        case 'u':
          rule1 = new DayInWeekField(selectNumberRule(7, tokenLen));
          break;
        case 'D':
        ...
        case 'W':
          ...
          break;
        case 'a':
          rule1 = new TextField(9, AmPmStrings);
          break;
        case 'k':
