...
public final class ZipEightByteInteger implements Serializable {
  ...
  public static BigInteger getValue(byte[] bytes, int offset) {
    long value = bytes[offset + 7] << 56L & 0x7F00000000000000L;
    value += bytes[offset + 6] << 48L & 0xFF000000000000L;
    value += bytes[offset + 5] << 40L & 0xFF0000000000L;
    value += bytes[offset + 4] << 32L & 0xFF00000000L;
    value += bytes[offset + 3] << 24L & 0xFF000000L;
    value += bytes[offset + 2] << 16L & 0xFF0000L;
    value += bytes[offset + 1] << 8L & 0xFF00L;
